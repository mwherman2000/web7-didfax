...
//
class __declspec(uuid("77070851-9449-4ae9-9c89-f295ed9868ab")) RenderFilterFactory : public UnknownBase<IClassFactory>
{
public:
    RenderFilterFactory() :
        m_serverLocks(0)
        ...
        )
    {
        ...
        *ppvObject = NULL;
        ...
        DIDFax1_Render_Filter::RenderFilter *pFilter = NULL;
        ...
        try
        {
            ...
            pFilter = new DIDFax1_Render_Filter::RenderFilter();
        }
        CATCH_VARIOUS(hr)
    ...
    )
{
    ...
    *ppv = NULL;
    ...
    if (rclsid != __uuidof(DIDFax1_Render_Filter::RenderFilterFactory))
    {
    ...
    DIDFax1_Render_Filter::RenderFilterFactory *pFactory = NULL;
    pFactory = new(std::nothrow) DIDFax1_Render_Filter::RenderFilterFactory();
...
DllCanUnloadNow()
{
    return (0 == DIDFax1_Render_Filter::RenderFilter::ms_numObjects) ? S_OK : S_FALSE;
}
    ...
    )
{
    ...
    case DLL_PROCESS_ATTACH:
        ...
        WPP_INIT_TRACING(L"DIDFax1RenderFilter");
